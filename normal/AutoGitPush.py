...
def main():
    test(
        ['jingdata-paas-metadata', 'jingdata-paas-message', 'jingdata-paas-search', 'jingdata-api-gateway', 'jingdata-paas-org',
         'jingdata-paas-auth', 'jingdata-paas-datarights', 'jingdata-paas-log-collection', 'jingdata-saas-investment'])
